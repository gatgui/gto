...
public:
  ...
  bool isCompatible(const Attrib &rhs) const;
  ...
  bool toHoudini(Gto::Reader *r, float sceneScale, HAttrib &dst);
  bool toHoudini(Gto::Reader *r, Gto::Reader *r0, Attrib *a0, Gto::Reader *r1, Attrib *a1, float blend, Attrib *v, float sceneScale, HAttrib &dst);
...
public:
  ...
  void toHoudini(Gto::Reader *r, float sceneScale);
  void toHoudini(Gto::Reader *r, Gto::Reader *r0, AttribDict *a0, Gto::Reader *r1, AttribDict *a1, float blend, float sceneScale);
